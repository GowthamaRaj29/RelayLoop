...
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function (_super) {
        ...
        function JwtAuthGuard_1(supabaseService) {
        ...
        JwtAuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, token, user, userRole, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            request.user = __assign({ id: user.id, email: user.email, role: (userRole === null || userRole === void 0 ? void 0 : userRole.role) || null, department: (userRole === null || userRole === void 0 ? void 0 : userRole.department) || null }, user);
