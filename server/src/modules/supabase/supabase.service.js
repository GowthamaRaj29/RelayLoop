...
var SupabaseService = function () {
    ...
    var SupabaseService = _classThis = /** @class */ (function () {
        function SupabaseService_1(configService) {
            ...
            var supabaseUrl = this.configService.get('supabase.url');
            var supabaseServiceKey = this.configService.get('supabase.serviceKey');
        ...
        SupabaseService_1.prototype.verifyToken = function (token) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (error) {
                                this.logger.warn("Token verification failed: ".concat(error.message));
                                return [2 /*return*/, null];
                            }
                            return [2 /*return*/, data.user];
                        case 2:
                            error_1 = _b.sent();
                            this.logger.error('Error verifying token:', error_1);
                            return [2 /*return*/, null];
        ...
        SupabaseService_1.prototype.getUserRole = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a = _b.sent(), data = _a.data, error = _a.error;
                            if (error) {
                                this.logger.warn("Failed to get user role: ".concat(error.message));
                                return [2 /*return*/, null];
                            }
                            return [2 /*return*/, data];
                        case 2:
                            error_2 = _b.sent();
                            this.logger.error('Error getting user role:', error_2);
                            return [2 /*return*/, null];
                        case 3: return [2 /*return*/];
                    }
                });
